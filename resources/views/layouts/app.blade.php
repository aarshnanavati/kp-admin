    ...
    <div class="kp_kitchen_admin_panel_app">
        <aside id="sidebar" class="kp_kitchen_admin_panel_sidebar">
            ...
            <nav class="kp_kitchen_admin_panel_navigation">
                ...
                <a class="kp_kitchen_admin_panel_nav_item {{ request()->routeIs('dashboard') ? 'kp_kitchen_admin_panel_nav_item_active' : '' }}"
                ...
                <div class="kp_kitchen_admin_panel_nav_group">
                    ...
                    <div class="kp_kitchen_admin_panel_nav_group_items">
                        <a class="kp_kitchen_admin_panel_nav_sub_item {{ request()->routeIs('customers') ? 'kp_kitchen_admin_panel_nav_sub_item_active' : '' }}"
                            href="{{ route('customers') }}">Customers</a>
                        <a class="kp_kitchen_admin_panel_nav_sub_item {{ request()->routeIs('drivers') ? 'kp_kitchen_admin_panel_nav_sub_item_active' : '' }}"
                            href="{{ route('drivers') }}">Drivers</a>
                        <a class="kp_kitchen_admin_panel_nav_sub_item {{ request()->routeIs('users') ? 'kp_kitchen_admin_panel_nav_sub_item_active' : '' }}"
                            href="{{ route('users') }}">Admin Users</a>
                    </div>
                </div>
                ...
                <div class="kp_kitchen_admin_panel_nav_group">
                    ...
                    <div class="kp_kitchen_admin_panel_nav_group_items">
                        ...
                        <a class="kp_kitchen_admin_panel_nav_sub_item {{ request()->routeIs('notifications') ? 'kp_kitchen_admin_panel_nav_sub_item_active' : '' }}"
                            ...
                            Notifications <span id="notificationBadge" class="kp_kitchen_admin_panel_nav_badge"
                                style="margin-left:8px;">0</span>
                        </a>
                    </div>
                </div>
        ...
        <section class="kp_kitchen_admin_panel_main">
            <header class="kp_kitchen_admin_panel_header">
                <div class="kp_kitchen_admin_panel_header_left">
                    <button id="sidebarToggle" class="kp_kitchen_admin_panel_menu_button" aria-label="Open sidebar">
                        ☰
                    </button>
                ...
                <div class="kp_kitchen_admin_panel_header_right">
                    <label class="kp_kitchen_admin_panel_header_search">
                        ...
                        <input id="globalSearch" class="kp_kitchen_admin_panel_header_search_input" type="search"
                            placeholder="Search..." />
                    </label>
                    <button id="themeToggle" class="kp_kitchen_admin_panel_theme_button" type="button"
                    ...
                    <a class="kp_kitchen_admin_panel_header_notification_button" href="{{ route('notifications') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <span id="headerNotificationCount"
                            class="kp_kitchen_admin_panel_header_notification_count">0</span>
                    </a>
                    <div class="kp_kitchen_admin_panel_admin_profile">
                        <div class="kp_kitchen_admin_panel_admin_avatar">
